...
cnn.add(Resnet_block(64,(3,3),activation='relu'))
cnn.add(Resnet_block(64,(3,3),activation='relu'))
cnn.add(Resnet_block(128,(3,3),activation='relu',is_conv=True))
# cnn.add(MaxPooling2D(pool_size=(2,2)))
# cnn.add(Dropout(0.25))
# cnn.add(Resnet_block(128,(3,3),activation='relu'))
# cnn.add(Resnet_block(128,(3,3),activation='relu'))
# cnn.add(Resnet_block(256,(3,3),activation='relu'))
# cnn.add(MaxPooling2D(pool_size=(2,2)))
# cnn.add(Dropout(0.25))
# cnn.add(Resnet_block(256,(3,3),activation='relu'))
# cnn.add(Resnet_block(256,(3,3),activation='relu'))
# cnn.add(Resnet_block(512,(3,3),activation='relu'))
# cnn.add(MaxPooling2D(pool_size=(2,2)))
# cnn.add(Dropout(0.25))
# cnn.add(Resnet_block(512,(3,3),activation='relu'))
